...
<div class="form-group col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-12 2xl:col-span-12" >
<label for="permiso-Actualizador">PERMISO</label>
<textarea class="form-input " id="permiso-Actualizador" name="permiso" v-model="datoscampos.permiso" cols="30" rows="3" ></textarea>
</div>
<div class="form-group " hidden>
...
<textarea class="form-input " v-model="datoscamposMenu_aplicacion.permiso" id="permisoAgregarDatos" name="permiso" cols="30" rows="3" ></textarea>
</div>
<div class="form-group " hidden>
